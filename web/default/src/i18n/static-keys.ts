...
export const STATIC_I18N_KEYS = [
  ...
  'Affordable coding and professional work',
  ...
  'View all models',
  'Save up to',
  'The same models, at lower prices',
  'Model price comparison',
  'Official price per 1M output tokens',
  'Maximum savings on this site',
  'Prices may fluctuate and are for reference only. Actual prices are based on the model square.',
  'Flexible billing, use on demand',
  'No monthly fee, no subscription, pay for actual usage',
  'Usage-based billing',
